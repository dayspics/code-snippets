...
public class Utils {
    ...
    **/
    ...
    public static Properties loadDefaultProperties(){
        ...
        URL propURL = Utils.class.getClassLoader().getResource(DEFAULT_PROPERTIES_FILE);
        if (propURL != null){
            InputStream is = null;
            try{
                ...
                LoggerHelper.info(Utils.class, "Unable to load any configuration properties." + ex.getMessage(), ex);
            }
        }
    ...
    public static String getPropertyWithSubs(Properties props, String name){
        ...
        value = (value != null)? Utils.substVars(value, name, null, props): null;
        return value;
    }

    public static Map<String, String> getDefaultPropertiesWithPrefix(String prefix){
        Properties props = loadDefaultProperties();
    ...
    public static Map<String, String> getDefaultPropertiesWithPrefix(Properties props, String prefix){
        ...
        for(String currentPropertyKey: propertySet){
            if(currentPropertyKey.startsWith(prefix)){
                ...
                // Perform variable substitution for property.
                value = (value != null)? Utils.substVars(value, currentPropertyKey, null, props): null;
